...
class _AggiornaSchedaComuneState extends State<AggiornaSchedaComune> {
  ...
  Future<void> saveImage(Uint8List bytes) async {
    ...
    if (await _requestPermission(Permission.storage)) {
      await ImageGallerySaver.saveImage(bytes, name: "Mit_Comune_Aggiornato_$nIntervento");
    } else {
      return;
    }
  ...
  void _schedaScelta() {
    ...
    if(controller.contrattoComune.id == 0) _showToast(context, "Nessun contratto, crea un contratto");
